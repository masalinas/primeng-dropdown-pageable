...
export const DROPDOWN_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => DropdownPageable),
  multi: true
};
...
@Component({
    selector: 'p-dropdown-pageable',
    templateUrl: './dropdown-pageable.html',
    styleUrls: ['./dropdown-pageable.css'],
    animations: [
...
export class DropdownPageable implements OnInit,AfterViewInit,AfterContentInit,AfterViewChecked,OnDestroy,ControlValueAccessor {
...
@NgModule({
    ...
    exports: [DropdownPageable,SharedModule,ScrollingModule],
    declarations: [DropdownPageable,DropdownItem]
})
export class DropdownPageableModule { }
